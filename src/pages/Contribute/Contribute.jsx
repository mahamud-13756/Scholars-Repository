    ...
    fetch('http://localhost:5000/upload-file-to-google-drive', {
      ...
      .then((data) => {
        ...
        if (data.id) {
          ...
          const newDoc = { name: user.displayName, email: user.email, photoURL, docType, universityName, semester, departmentName, courseName, fileId: data.id,fileName:data.name, webContentLink: data.webContentLink, webViewLink: data.webViewLink, thumbnailLink: data.thumbnailLink, createdTime: data.createdTime }
      ...
      <div className="container mx-auto my-10">
        <div className="flex-col flex-row">
          <div className="text-center text-left">
            <h1 className="text-3xl text-[#000000] font-bold">Upload your Contents</h1>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="card-body">
                ...
                <div className="text-center mt-3">
                  If you get points then <Link to="/Register" className="text-blue-500 hover:underline">sign up</Link>
                </div>
              </div>
            </form>
          </div>
